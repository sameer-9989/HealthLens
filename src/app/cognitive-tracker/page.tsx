...
import { Brain, Info } from "lucide-react"; // Changed Brain to Info for consistency
      ...
      <Card className="shadow-lg text-center">
        <CardHeader>
          ...
          <CardTitle className="text-2xl font-bold flex items-center justify-center">
            <Brain className="h-7 w-7 mr-2 text-destructive" /> {/* Icon to match other "removed" pages */}
            Cognitive Health Tracker - Removed
          </CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground">
            ...
            For cognitive concerns or mental wellness support, please consult our Virtual Nursing Assistant.
          </p>
