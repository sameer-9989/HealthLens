...
const SymptomCheckerOutputSchema = z.object({
  ...
  triageRecommendations: z.string().describe('General recommendations for seeking medical care based on the symptoms. If symptoms suggest a medical emergency (e.g., chest pain, difficulty breathing, severe bleeding, stroke signs), this MUST strongly advise immediate emergency medical attention.'),
...
const prompt = ai.definePrompt({
  ...
  4. Provide general Triage Recommendations. 
     **CRITICAL SAFETY INSTRUCTION:** If the described '{{{symptoms}}}' include phrases like "chest pain", "difficulty breathing", "can't breathe", "severe bleeding", "stroke symptoms" (like sudden numbness, confusion, trouble speaking/seeing), "loss of consciousness", "severe allergic reaction", or anything that sounds like a medical emergency, the 'triageRecommendations' MUST STRONGLY and CLEARLY state that the user should seek **immediate emergency medical attention (e.g., call 911 or local emergency number, or go to the nearest emergency room)**. This overrides all other triage advice.
     For less severe symptoms, suggest monitoring and consulting a doctor if they persist or worsen.
