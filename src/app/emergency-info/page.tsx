      ...
      <Card className="shadow-lg text-center">
        <CardHeader>
          ...
          <CardTitle className="text-2xl font-bold flex items-center justify-center">
            <ShieldAlert className="h-7 w-7 mr-2 text-destructive" /> {/* Icon to match other "removed" pages */}
            Secure Emergency Info Builder - Removed
          </CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground">
            We are currently focusing on other core health features.
          </p>
