      ...
      <Card className="shadow-lg text-center">
        <CardHeader>
          ...
          <CardTitle className="text-2xl font-bold flex items-center justify-center">
            <GitCompareArrows className="h-7 w-7 mr-2 text-destructive" />
            Habit Conflict Detector - Removed
          </CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground">
            We are currently focusing on other core health planning and assistance features.
            For questions about combining health routines, please consult our Virtual Assistant or a healthcare professional.
          </p>
