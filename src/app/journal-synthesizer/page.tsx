      ...
      <Card className="shadow-lg text-center">
        <CardHeader>
          ...
          <CardTitle className="text-2xl font-bold flex items-center justify-center">
            <FileText className="h-7 w-7 mr-2 text-destructive" /> {/* Icon to match other "removed" pages */}
            Journal Synthesizer - Removed
          </CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground">
            ...
            Alternative methods for note summarization may be explored in the future.
          </p>
